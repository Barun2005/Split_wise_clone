...
export function ThemeToggle() {
  ...
  return (
    <Button
      variant="outline"
      size="icon"
      className="rounded-full bg-white/50 hover:bg-white/80 dark:bg-slate-800/50 dark:hover:bg-slate-800/80 border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm"
